...
const TUITS_API = "https://tuiter-node-a3.herokuapp.com/api/tuits";
const USERS_API = "https://tuiter-node-a3.herokuapp.com/api/users";
...
export const deleteTuitByUser = (tuit) =>
    axios.delete(`${TUITS_API}/${tuit}`)
        .then(response => response.data);
